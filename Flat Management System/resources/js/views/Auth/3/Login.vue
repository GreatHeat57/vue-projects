<template>
    <el-form class='login2-container'>
        ...
        <el-form :model="model" ref="form">
            <el-form-item prop="email" :label="$t('general.email-')" :rules="validationRules.email" v-bind:class="[email_input, emailfocus, emailfocus_sub]" id="email_input">
                <el-input
                    type="email" 
                    v-model="model.email" 
                    autocomplete="off"
            ...
            <el-form-item prop="password" :label="$t('general.password')" :rules="validationRules.password" v-bind:class="[pwd_input, pwdfocus, pwdfocus_sub]" id="pwd_input">
                <el-input
                    type="password" 
...
<script>
    ...
    export default {
        ...
        methods: {
            focus(obj) {
                if (obj == 'email') {
                    this.emailfocus = 'input_focus_email';
                    this.emailfocus_sub = 'input_focus_email_sub';
                    this.pwdfocus = '';
                }
                else {
                    this.pwdfocus = 'input_focus_pwd';
                    this.pwdfocus_sub = 'input_focus_pwd_sub';
                    this.emailfocus = '';
                }
            }
        },
